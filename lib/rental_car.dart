...
var rentalCar = [
  RentalCar(
    ...
    available: true,
    description: "Toyota Avanza adalah mobil keluarga terpopuler di Indonesia dengan kapasitas penumpang hingga 7 orang. "
        "Mobil ini dilengkapi dengan fitur-fitur keselamatan dan "
        "kenyamanan seperti kamera parkir belakang dan sistem pengereman ABS, "
        "sehingga membuat perjalanan Anda lebih aman dan nyaman. "
        "Selain itu, ruang kabin yang lega juga akan membuat Anda dan keluarga merasa nyaman selama perjalanan.",
    images: [
